...
/**
 * davedes' Tutorials Alpha Map Lighting
...
public class LightingTestAlpha extends BasicGame {
    ...
    //our lights
    private List<LightingTestAlpha.Light> lights = new ArrayList<LightingTestAlpha.Light>();
    ...
    public void init(GameContainer container) throws SlickException {
        ...
        spriteSheet = new Image("sprite.png", false, Image.FILTER_NEAREST);
        ...
        //grab the alpha map
        alphaMap = spriteSheet.getSubImage(0, TILE_SIZE + TILE_SPACING - 45, ALPHA_MAP_SIZE, ALPHA_MAP_SIZE);
    ...
    public void resetLights(GameContainer container) {
        ...
        lights.clear();
        lights.add(new LightingTestAlpha.Light(container.getInput().getMouseX(), container.getInput().getMouseY(), 1f));
    }
    ...
    public void render(GameContainer container, Graphics g) throws SlickException {
        ...
        for (int i = 0; i < lights.size(); i++) {
            LightingTestAlpha.Light light = lights.get(i);
    ...
    public void update(GameContainer container, int delta)
        ...
        if (lights.size() > 0) {
            LightingTestAlpha.Light l = lights.get(lights.size() - 1);
    ...
    public void mousePressed(int button, int x, int y) {
        ...
        lights.add(new LightingTestAlpha.Light(x, y, randSize, randColor));
    }
